---
name: imc-plan
description: "This skill should be invoked when the user wants a marketing strategy, campaign plan, or channel strategy -- even if they just say 'how do I market this', 'I have a product but no go-to-market plan', 'we have no marketing plan', 'nobody knows about us', 'how do I get the word out', or 'how do I promote this.' Triggers include planning a marketing launch, GTM strategy, choosing channels, 'which channels should I use', 'should I be on TikTok or LinkedIn', 'how should we position this', content strategy, content calendar, or 'get my first users.' Not for writing actual content (use content-create), setting numeric targets (use funnel-planner), strategic prioritization across non-marketing levers (use solution-design), or organic search strategy (use seo)."
license: MIT
metadata:
  author: hungv47
  version: "7.2.0"
